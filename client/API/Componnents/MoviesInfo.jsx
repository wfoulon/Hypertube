...
const MovieUrl = 'https://localhost:5000/api/v1/movie_infos'
import {Button} from 'mdbreact'

export default class MoviesSug extends Component {
  constructor(props) {
    super(props)
    this.state = {
      input: {
    ...
    return (
      <div>
        <div className='Index-Movie-Resume-Title-container Title-recom'>
          <span className='Index-Movie-Resume-Title'>Movies infos</span>
        </div>
        <div className='api-ContentExample-definition'>
          <span style={{fontSize: '15px', fontWeight: 500}}>Get all informations about a movie (images, cast, prod, rate ...).</span>
        </div>
