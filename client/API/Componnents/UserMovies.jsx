...
const MovieUrl = 'https://localhost:5000/api/v1/user_movies'
    ...
    return (
      <div>
        <div className='Index-Movie-Resume-Title-container Title-recom'>
          <span className='Index-Movie-Resume-Title'>Your movies</span>
        </div>
        <div className='api-ContentExample-definition'>
          <span style={{fontSize: '15px', fontWeight: 500}}>Get your watched and watching movies</span>
        </div>
