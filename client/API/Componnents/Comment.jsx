...
const MovieUrl = 'https://localhost:5000/api/v1/user_post_movie_comment'
    ...
    return (
      <div>
        <div className='Index-Movie-Resume-Title-container Title-recom'>
          <span className='Index-Movie-Resume-Title'>Send comment</span>
        </div>
        <div className='api-ContentExample-definition'>
          <span style={{fontSize: '15px', fontWeight: 500}}>Post a comment for a movie</span>
        </div>
        <div className='Main-query-Content'>
          ...
          <div className='api-query-content'>
            ...
            <SingleQuery placeHolder='String (Api_request_id from your informations)' name='userId' inputVal={input.userId} OnChange={this.onChange} required={true} />
            <SingleQuery placeHolder='Integer (From movies data)' name='movie_id' inputVal={input.movie_id} OnChange={this.onChange} required={true} />
            <SingleQuery placeHolder='String (Your comment)' name='comment' inputVal={input.comment} OnChange={this.onChange} required={true} />
          </div>
