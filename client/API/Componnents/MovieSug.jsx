...
const MovieUrl = 'https://localhost:5000/api/v1/movie_suggestion'
    ...
    return (
      <div>
        <div className='Index-Movie-Resume-Title-container Title-recom'>
          <span className='Index-Movie-Resume-Title'>Movies suggestion</span>
        </div>
        <div className='api-ContentExample-definition'>
          <span style={{fontSize: '15px', fontWeight: 500}}>Get a list of recommended movies for a movie</span>
        </div>
